                   ...
                   <div class="social">
                        ...
                        <div class="search">
                            <form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                ...
                                <input type="text" class="search-form" autocomplete="on" placeholder="Search" value="<?php echo get_search_query(); ?>" name="s" id="s" />
                                <i class="fa fa-search" type="submit" id="searchsubmit" value="<?php echo esc_attr_x( 'Search', 'submit button' ); ?>"></i>
                            </form>
                       </div>
                   </div>
                </div>
